...
const API_ERRORS = {
  uk: {
    ...
    reviewResultInvalid: "Запуск завершився без коректної відповіді. Запустіть крок ще раз.",
  ...
  en: {
    ...
    reviewResultInvalid: "The review run finished without a valid result. Run the step again.",
