...
Відповідь має складатися рівно з трьох секцій у такому порядку:

## 1. Загальний огляд
Обов'язкова секція на початку (150-300 слів). Оціни текст за шістьма критеріями:
...
## 2. Детальний аналіз
Поблочний розбір проблемних місць (1-3 абзаци на кожен проблемний блок). Для кожного блоку вкажи:
