...
- Structure is a focused heading-insert tool with harder server filtering and clearer prompts. Remaining risk is model quality of titles; outline + anti-copy rules reduce copycat headings but do not eliminate them.
