...
- Manuscript subsection ghosts use a minimal display: blue heading text (+ small H2/H3 badge) and quiet Insert/Reject under the active ghost — no dashed card, gradient, or blue highlight bar on the following paragraph
